        ...
        <div className="contact-page-top-info space-mb--r100">
          <Container>
            ...
            <Row className="space-mb-mobile-only--m50">
              ...
              The PIN codes adjusted by us are often refreshed, so in the event that we don't convey to your PIN code today, if it's not too much trouble, return and verify whether this has changed.
.<br/><br/>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Conveyance time for the orders could be 2-3 working days in view of the area. This does exclude Sundays and Public Occasions.
<br/>
<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;All Questions are dependent upon Tamil Nadu Ward..<br/><br/></p>
         </Row>
          </Container>
        </div>
        <br/>
