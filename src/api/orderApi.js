...
const addPurchases = async (params) => {
  try {
    const result = await axioss.post(`/add_customer_purchases`, params);
...
const get_all_purchases = async (filter = null) => {
  try {
    ...
    const result = await axioss.post(`/show_all_customer_purchases`, params);
...
const getOrderDetailsByID = async (id) => {
  try {
    ...
    const result = await axioss.post("/get_order_details", params);
...
const editOrderDetails = async (id, orderData) => {
  try {
    ...
    const result = await axioss.post(`/edit_order_details`, params);
    return result ? result.data : null;
  } catch (e) {
    return null;
  }
...
const get_all_receipts = async () => {
  try {
    const result = await axioss.get(`/show_all_receipts`);
...
const showCustomerPurchases = async (customer) => {
  try {
    ...
    const result = await axioss.post(`/show_customer_purchases`, params);
    return result ? result.data.purchases : null;
  } catch (e) {
    return null;
  }
...
const cancelCustomerOrder = async (order_id) => {
  try {
    ...
    const result = await axioss.post(`/cancel_order`, params);
    return result ? result.data : null;
  } catch (e) {
    return null;
  }
